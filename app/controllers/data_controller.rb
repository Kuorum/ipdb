  ...
  private
    ...
    def require_permission  
      ...
      if params[:region_id] != "" && !params[:region_id].blank?
        ...
        region_id = @datum.region_id.to_s 
      end
